...
const puzzleWords6 = [
  ...
  'ORIENT', 'DATERS', 'TREADS', 'LASTED', 'SALTED', 'SLATED', 'STALED',
  'DELTAS', 'PASTEL', 'PETALS', 'PLATES', 'PLEATS', 'STAPLE', 'PALEST', 'ALERTS',
  'ALTERS', 'LASTER', 'SALTER', 'SLATER', 'STELAR', 'ANTLER', 'LEARNT', 'RENTAL',
  'ESPRIT', 'PRIEST', 'RIPEST', 'SPRITE', 'TRIPES', 'REMITS', 'MERITS', 'MISTER',
  'MITERS', 'MITRES', 'SMITER', 'TIMERS', 'DIREST', 'DRIEST', 'STRIDE', 'CARIES',
  'SATIRE', 'STRIAE', 'ARIOSE', 'SORTIE'
];
...
const puzzleWords7 = [
  ...
  'STACKER', 'STAPLER', 'STEWARD', 'STORAGE', 'STRANGE', 'TAILERS',
  'TEASING', 'THREADS', 'TOASTED', 'TREASON', 'TRIPLED', 'TRUSTED'
];

// 8-letter words (levels 11+)
const puzzleWords8 = [
  'ADMIRALS', 'ALERTING', 'ALTERING', 'ASTEROID', 'BANISTER', 'CHAPTERS',
  'CITADELS', 'CLIMATES', 'COASTERS', 'EASTWARD', 'ENTRAILS', 'FINAGLED',
  'FLOATING', 'GRADIENT', 'GRANITES', 'GYRATION', 'HAIRIEST', 'HANDLING',
  'HASTENED', 'LANTERNS', 'LATRINES', 'MALTSTER', 'MASTERED', 'MEDIATOR',
  'MIGRANTS', 'PAINTERS', 'PARTINGS', 'PASTURED', 'PLASTERS', 'REACTING',
  'READOUTS', 'REDCOATS', 'RELATING', 'REPLANTS', 'RETAINED', 'ROUNDEST',
  'SALARIED', 'SCANTIER', 'SEDATION', 'SLANDERS', 'SMELTING', 'STAMPEDE',
  'STEADING', 'STRAINED', 'STRANGLE', 'STREAMED', 'THATCHES', 'TOASTING',
  'TREASONS', 'TRIANGLE'
];
